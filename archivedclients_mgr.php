...
$_SESSION['uzuriweb_archivedclients_search'];
$_SESSION['uzuriweb_wbm_modes'];

//Include common files
include('includes/wbm_common.php');
include('functions/archivedclients_fns.php');
...
if ($uzuriweb_log_val <> "")
{
	...
	$_SESSION['uzuriweb_archivedclients_search']="Nosearch";
	header('Location: archivedclients_mgr.php');
	}
	
	$uzuriwebpgname="archivedclients_mgr";
	$strPath = "";
	$strTitle = 'Manage Archived Clients';
	...
	if ((isset($_GET['search']) && ($_GET['search'])=='y')){
	    $_SESSION['uzuriweb_archivedclients_search']="Search";
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    <td colspan="2" valign="top">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="63%" valign="top" class="breadcrumbs"><strong>YOU ARE HERE:</strong> <a href="dashboard.php">Dashboard</a>&nbsp;->&nbsp;Manage Archived Clients</td>
