<?php
include($_SERVER['DOCUMENT_ROOT'].'/uzuriweb/wbm/foto_upload_script.php');
...
$foto_upload->upload_dir = $_SERVER['DOCUMENT_ROOT']."/uzuriweb/upload/";
$foto_upload->foto_folder = $_SERVER['DOCUMENT_ROOT']."/uzuriweb/upload/";
$foto_upload->thumb_folder = $_SERVER['DOCUMENT_ROOT']."/uzuriweb/upload/thumb/";
$foto_upload->extensions = array(".jpg", ".gif", ".png");
$foto_upload->language = "en";
$foto_upload->x_max_size = 480;
$foto_upload->y_max_size = 360;
$foto_upload->x_max_thumb_size = 250;
$foto_upload->y_max_thumb_size = 250;
