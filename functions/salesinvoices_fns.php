<?php
if(preg_match("/salesinvoices_fns.php/i",$_SERVER['PHP_SELF'])) {
...
function LoadRecords() {
	...
	$realmode=$_SESSION['uzuriweb_salesinvoices_search'];
	if ($realmode=="Search")
	{
		...
		if($strSearchName)
			{
				$query = $query." WHERE ($strSearchColumn LIKE '%$strSearchName%'"; 
				$sq = $sq." WHERE ($strSearchColumn LIKE '%$strSearchName%'"; 
			}
	...
	elseif ($realmode=="Nosearch")
	{
		...
		$offset = ($pageNum - 1) * WBM_ROWS_PERVIEW;
		$query  = "SELECT * FROM wbm_salesleads ORDER BY ID DESC";
		$sq   = "SELECT COUNT(ID) AS numrows FROM wbm_salesleads ORDER BY ID DESC";
		if($sortby)
			{
	...
	while($row = mysql_fetch_array($result))
	{
		...
		echo $strLeadstatus; 
		echo "</td>\n";
		echo "<td class=\"frmTabletxt\"><a href=\"salesinvoices_mgr.php?mode=edit&ID=";
		echo $strID;
		echo "\"><img src=\"images/edit.png\" width=\"12\" height=\"13\" vspace=\"2\" border=\"0\"></a> | \n";
		echo "<a href=\"salesinvoices_mgr.php?mode=delete&ID=";
		echo $strID;
		echo " \"onClick=\"return confirm('Are you sure you want to delete this Sales Lead?')\"><img src=\"images/delete.gif\" width=\"11\" height=\"11\" vspace=\"2\" border=\"0\"></a>\n";
		echo "</td>\n";
		echo "</tr>\n";
	}
		echo "<tr>\n";
...
function AddRecord($action) {
	...
	<td>&nbsp;</td>
	  ...
	  <tr>
		...
		<td><input name="company" type="text" id="company" style="width: 400px;" class="buttontxt" /></td>
	  </tr>
	  <tr>
		<td align="right" class="formscss">First Name <em>(Contact Person)</em> :*</td>
		<td><input name="fname" type="text" id="fname" style="width: 400px;" class="buttontxt" /></td>
	  </tr>
	  <tr>
		<td align="right" class="formscss">Last Name <em>(Contact Person)</em> :*</td>
		<td><input name="lname" type="text" id="lname" style="width: 400px;" class="buttontxt" /></td>
	  </tr>
	  <tr>
		<td align="right" class="formscss">Email Address  :*</td>
		<td><input name="email" type="text" id="email" style="width: 400px;" class="buttontxt" /></td>
		</tr>
	  <tr>
	  ...
	  <tr>
		...
		<td><input name="telno" type="text" id="telno" style="width: 400px;" class="buttontxt" /></td>
		</tr>
	  <tr>
		<td align="right" class="formscss">Cellphone Number :</td>
		<td><input name="cellno" type="text" id="cellno" style="width: 400px;" class="buttontxt" /></td>
		</tr>
	  <tr>
		<td align="right" class="formscss">Website URL :*</td>
		<td><input name="website" type="text" id="website" style="width: 400px;" class="buttontxt" /></td>
		</tr>
	  <tr>
		<td align="right" class="formscss">Lead Title :*</td>
		<td><input name="leadtitle" type="text" id="leadtitle" style="width: 400px;" class="buttontxt" /></td>
		</tr>
	  <tr>
...
function EditRecord($action, $strID) {
	...
	$result=@mysql_query("SELECT * FROM wbm_salesleads WHERE ID = '$strID'");
	...
	<FORM name="frmEntry" action="<?=$_SERVER['PHP_SELF']?>" METHOD="POST">
	  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
		...
		<tr>
		  ...
		  <tr>
			<td align="right" class="formscss">Company Name  :*</td>
			<td><input name="company" type="text" id="company" style="width: 400px;" class="buttontxt" value="<?php echo $strCompany;?>" /></td>
		  </tr>
		  <tr>
			<td align="right" class="formscss">First Name <em>(Contact Person)</em> :*</td>
			<td><input name="fname" type="text" id="fname" style="width: 400px;" class="buttontxt" value="<?php echo $strFname;?>" /></td>
		  </tr>
		  <tr>
			<td align="right" class="formscss">Last Name <em>(Contact Person)</em> :*</td>
			<td><input name="lname" type="text" id="lname" style="width: 400px;" class="buttontxt" value="<?php echo $strLname;?>" /></td>
		  </tr>
		  <tr>
			<td align="right" class="formscss">Email Address  :*</td>
			<td><input name="email" type="text" id="email" style="width: 400px;" class="buttontxt" value="<?php echo $strEmail;?>" /></td>
			</tr>
		  <tr>
			<td align="right" class="formscss">Physical Location  :</td>
		  ...
		  <tr>
			<td align="right" class="formscss">Telephone Number :</td>
			<td><input name="telno" type="text" id="telno" style="width: 400px;" class="buttontxt" value="<?php echo $strTelephone;?>" /></td>
			</tr>
		  <tr>
			<td align="right" class="formscss">Cellphone Number :</td>
			<td><input name="cellno" type="text" id="cellno" style="width: 400px;" class="buttontxt" value="<?php echo $strCellphone;?>" /></td>
			</tr>
		  <tr>
			<td align="right" class="formscss">Website URL :*</td>
			<td><input name="website" type="text" id="website" style="width: 400px;" class="buttontxt" value="<?php echo $strWebsite;?>" /></td>
			</tr>
		  <tr>
			<td align="right" class="formscss">Lead Title :*</td>
			<td><input name="leadtitle" type="text" id="leadtitle" style="width: 400px;" class="buttontxt" value="<?php echo $strLeadtitle;?>" /></td>
			</tr>
		  <tr>
			<td align="right" class="formscss">Lead Description  :</td>
...
function ProcessEditForm($formValues) {
	...
	mysql_query("UPDATE wbm_salesleads SET fname='$strFname', lname='$strLname', company='$strCompany', email='$strEmail', location='$strLocation', pobox='$strPobox', telephone='$strTelno', cellphone='$strCellno', website='$strWebsite', leadtitle='$strLeadtitle', leaddesc='$strLeaddesc', leadsource='$strLeadsource', leadstatus='$strLeadstatus' WHERE ID=$strID LIMIT 1") or die (mysql_error());
	// Redirect to Main page
	header('Location: salesinvoices_mgr.php');
	exit();
}
...
function DeleteRecord($strID) {
	mysql_query("DELETE FROM wbm_salesleads WHERE ID='$strID'") or die(mysql_error());
	// Redirect to Main page
	header('Location: salesinvoices_mgr.php');
	exit();
}
...
function ActivateRecord($strID) {
	$strPublished = date('Y-m-d');
    $strPublishedBy = $_SESSION['uzuriweb_wbm_authenticate_id'];
	mysql_query("UPDATE wbm_salesleads SET active=1 WHERE ID='$strID' LIMIT 1") or die(mysql_error());
	// Redirect to Main page
	header('Location: salesinvoices_mgr.php');
	exit();
}
