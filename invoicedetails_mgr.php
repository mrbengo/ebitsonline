...
$_SESSION['uzuriweb_invoicedetails_search'];
...
include('functions/invoicedetails_fns.php');
...
if ($uzuriweb_log_val <> "")
{
	...
	//$_SESSION['uzuriweb_invoicedetails_search']="Nosearch";
	//header('Location: invoicedetails_mgr.php');
	//}
	$_SESSION['invoicecode'] = rtrim($_GET['invoice']);
	$uzuriwebpgname="invoicedetails_mgr";
	$strPath = "";
	$strTitle = 'Invoice Details';
	...
	if ((isset($_GET['search']) && ($_GET['search'])=='y')){
	    $_SESSION['uzuriweb_invoicedetails_search']="Search";
