...
<br>
	...
	//Get proforma invoice amount
	$sqlname = "SELECT * FROM wbm_pro_invoices WHERE invoiceNum='$strProInvoice' AND companyid=$strWbmCompanyid LIMIT 1";
	$resultname = mysql_query($sqlname) or die(mysql_error());
	$rowname = mysql_fetch_array($resultname);
	$strTotDiscount = $rowname['discount']; 	
	$strTotSubTotal = $rowname['subTotal']; 	
	$strTotDiscountamnt = $rowname['discountamnt']; 	
	$strTotSalesTax = $rowname['salesTax']; 	
	$strTotInvoiceAmount = $rowname['invoiceAmount'];
	$strTotNewSubTotal = $strTotSubTotal+$strTotDiscountamnt;
	$strTotNewSubTotal = number_format($strTotNewSubTotal, 2,".",",");
	$strTotalInvoiceAmount = number_format($strTotInvoiceAmount, 2,".",",");
	...
	echo "<td>&nbsp;</td>\n";
	echo "<td>&nbsp;</td>\n";
	echo "<td class=\"inputheader\" colspan=\"2\">SUB TOTAL AMOUNT:</td>\n";
		echo "<td class=\"frmTabletxt2\" align=\"right\"><strong>\n";
		echo $strTotNewSubTotal; 
		echo "</strong></td>\n";
	echo "</tr>\n";	
	echo "<tr>\n";
	echo "<td>&nbsp;</td>\n";
	echo "<td>&nbsp;</td>\n";
	echo "<td class=\"inputheader\" colspan=\"2\">TOTAL INVOICE AMOUNT (Inclusive of 16% VAT):</td>\n";
		echo "<td class=\"frmTabletxt2\" align=\"right\"><strong>\n";
		echo $strTotalInvoiceAmount; 
		echo "</strong></td>\n";
	echo "</tr>\n";	
	...
	echo "<td>&nbsp;</td>\n";
	echo "<td>&nbsp;</td>\n";
	echo "<td class=\"inputheader\" colspan=\"3\">THIS PAYMENT-------------------------------------</td>\n";
	echo "</tr>\n";	
