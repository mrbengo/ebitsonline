...
$_SESSION['uzuriweb_statements_search'];
$_SESSION['uzuriweb_wbm_modes'];

//Include common files
include('includes/wbm_common.php');
include('functions/statements_fns.php');
...
if ($uzuriweb_log_val <> "")
{
	...
	$uzuriwebpgname="statements_mgr";
	$strPath = "";
	$strTitle = 'Statement Generator';
	
	$strStatement = rtrim($_GET['rpt']);
	if ($strStatement==""){
	$_SESSION['uzuriweb_wbm_modes']="statement";
	}
	if ($strStatement=="statement"){
	$_SESSION['uzuriweb_wbm_modes']="statement";
	}
