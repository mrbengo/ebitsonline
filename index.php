  ...
  <tr>
    <td><table width="775" height="351"  border="0" align="center" cellpadding="0" cellspacing="0" background="images/mainaccessbg.png">
      ...
      <tr>
		...
		<table width="43%"  border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="96%" valign="top">
				...
				if ($_POST['action'] == "login") {
					loginAuthenticateUser($HTTP_POST_VARS);												
				}
				else {
					// Generate Login Form
					$mesg = "Enter your email address and Password.";
					GenloginForm($mesg, "login");
				}
				?>
