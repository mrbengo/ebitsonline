...
$_SESSION['uzuriweb_projectteam_search'];
$_SESSION['uzuriweb_wbm_modes'];

//Include common files
include('includes/wbm_common.php');
include('functions/projectteam_fns.php');
...
if ($uzuriweb_log_val <> "")
{
	...
	$_SESSION['uzuriweb_projectteam_search']="Nosearch";
	header('Location: projectteam_mgr.php');
	}
	
	$uzuriwebpgname="projectteam_mgr";
	$strPath = "";
	$strTitle = 'Manage Project Team';
	...
	if ((isset($_GET['search']) && ($_GET['search'])=='y')){
	    $_SESSION['uzuriweb_projectteam_search']="Search";
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    <td colspan="2" valign="top">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="63%" valign="top" class="breadcrumbs"><strong>YOU ARE HERE:</strong> <a href="dashboard.php">Dashboard</a>&nbsp;->&nbsp;Manage Project Team</td>
