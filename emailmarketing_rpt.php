...
if ($uzuriweb_log_val <> "")
{
	...
	$strPath = "";
	$strTitle = 'Email Marketing Report';
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td colspan="3" align="center" class="titletx">Email Marketing Report</td>
  </tr>
</table>
...
<?
	...
	if (isset($_GET['PB'])) //if input from form
	{
		...
		$query="SELECT * FROM wbm_emailmarketing WHERE companyid=$strWbmCompanyid";
		if(($strDatefrom)&&($strDateto))
			{
				$query = $query." AND setupdate BETWEEN '$strDatefrom' AND '$strDateto'"; 
			}	
		if($strPackage <> 0)
			{
				$query = $query." AND planid=$strPackage"; 
			}	
