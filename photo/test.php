...
include ($_SERVER['DOCUMENT_ROOT']."/uzuriweb/wbm/photo/foto_upload_script.php"); //classes is the map where the class file is stored (one above the root)
...
$foto_upload->upload_dir = $_SERVER['DOCUMENT_ROOT']."/uzuriweb/files/"; // "files" is the folder for the uploaded files (you have to create these folder)
$foto_upload->foto_folder = $_SERVER['DOCUMENT_ROOT']."/uzuriweb/files/photo/";
$foto_upload->thumb_folder = $_SERVER['DOCUMENT_ROOT']."/uzuriweb/files/thumb/";
