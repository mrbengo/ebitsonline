...
if ($uzuriweb_log_val <> "")
{
	...
	$_SESSION['uzuriweb_cheque_search']="Nosearch";
	header('Location: cheque_mgr.php');
	}
	
	$uzuriwebpgname="cheque_mgr";
	$strPath = "";
	$strTitle = 'Cheque Management';
	$strID = rtrim($_GET['ID']);
	...
	if ((isset($_GET['search']) && ($_GET['search'])=='y')){
	    $_SESSION['uzuriweb_cheque_search']="Search";
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    <td colspan="2" valign="top">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="48%" valign="top" class="breadcrumbs"><strong>YOU ARE HERE:</strong> <a href="dashboard.php">Dashboard</a>&nbsp;->&nbsp;Manage Cheques</td>
