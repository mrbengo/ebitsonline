...
include('functions/invoices_fns.php');
...
if ($uzuriweb_log_val <> "")
{
	...
	$_SESSION['uzuriweb_invoices_search']="Nosearch";
	header('Location: invoices_mgr.php');
	}
	
	$uzuriwebpgname="invoices_mgr";
	$strPath = "";
	...
	if ((isset($_GET['search']) && ($_GET['search'])=='y')){
	    $_SESSION['uzuriweb_invoices_search']="Search";
