...
$_SESSION['uzuriweb_salesleads_search'];
$_SESSION['uzuriweb_wbm_modes'];

//Include common files
include('includes/wbm_common.php');
include('functions/salesleads_fns.php');
...
if ($uzuriweb_log_val <> "")
{
	...
	$_SESSION['uzuriweb_salesleads_search']="Nosearch";
	header('Location: salesleads_mgr.php');
	}
	
	$uzuriwebpgname="salesleads_mgr";
	$strPath = "";
	$strTitle = 'Manage Sales Leads';
	...
	if ((isset($_GET['search']) && ($_GET['search'])=='y')){
	    $_SESSION['uzuriweb_salesleads_search']="Search";
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
	    <td colspan="2" valign="top">
	      <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="63%" valign="top" class="breadcrumbs"><strong>YOU ARE HERE:</strong> <a href="dashboard.php">Dashboard</a>&nbsp;->&nbsp;Sales Leads</td>
